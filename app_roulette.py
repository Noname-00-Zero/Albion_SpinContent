"""
Albion Roulette — Streamer Build Roulette & Challenge Generator
=============================================================
...
APP_URL = "https://albionspincontent-2tjxlovqc7rl7xn2j9cjnm.streamlit.app/?embed=true"
OG_TITLE = "Albion Roulette | Build Randomizer & Challenge Generator"
OG_DESCRIPTION = (
...
st.set_page_config(
    page_title="Albion Roulette — Build Randomizer",
    page_icon="⚔️",
    layout="centered",
...
def loadout_to_share(lo: Loadout) -> str:
    ...
    return (
        ...
        f"🧣 Cape      : {_named(lo, lo.cape, 'cape', 'None')}\n\n"
        f"🔥 CHALLENGE : {_clean_challenge(lo.challenge)}\n\n"
        f"🎲 Generated by Albion Roulette — Support the Dev: {KOFI_URL}"
    )
